 ...
 */
/* "$Id: params.h,v 1.13 2002/12/05 20:18:27 rkambic Exp $" */
...
#define PARM_SOILW	144	/* Volumetric soil moisture content */
#define PARM_PEVPR	145	/* Potential evaporation rate */
#define PARM_CWORK	146	/* Cloud workfunction */
#define PARM_U_GWD	147	/* Zonal flux of gravity wave stress */
#define PARM_V_GWD	148	/* Meridional flux of gravity wave stress */
#define PARM_PV		149	/* Potential vorticity */
...
#define PARM_RWMR	170	/* Rain water mixing ratio */
#define PARM_SNMR	171	/* Snow water mixing ratio */
...
#define PARM_ICMR	178	/* Ice water mixing ratio */
#define PARM_GRMR	179	/* Graupel water mixing ratio */
#define PARM_GUST	180	/* Surface wind gust */
...
#define PARM_TPFI	185	/* Turbulence Potential Forecast Index */
#define PARM_TIPD	186	/* Total Icing Potential Diagnostic */
#define PARM_LTNG	187	/* Lightning */
...
#define PARM_NCIP	198	/* Number concentration for ice particles */
#define PARM_EVBS	199	/* Direct evaporation from bare soil */
#define PARM_EVCW	200	/* Canopy water evaporation */
#define PARM_NOICE_WAT	201	/* Ice-free water surface, % */
#define PARM_CWDI	202	/* Convective weather detection index */
...
#define PARM_TRANS	210	/* Transpiration */
...
#define PARM_SOTYP	224	/* Soil type (as in Zobler) */
#define PARM_VGTYP	225	/* Vegitation type (as in SiB) */
...
#define PARM_GPT_HGTA5	230	/* 5-wave geopotential height anomaly */
...
#define PARM_SIPD	236	/* Supercooled Large Droplet (SLD) Icing Potential Diagnostic */
#define PARM_OZTOT	237	/* Total ozone, Kg/m2*/
#define PARM_SNO_CVR	238	/* Snow cover, percent */
#define PARM_SNO_T	239	/* Snow temperature, K */
#define PARM_COVTW	240	/* Covariance between temperature and vertical component of the wind */
